...
public class TalonEncoderClimber extends TimerTask {
	...
	public TalonEncoderClimber(TalonSRX talon) {
		this.talon = talon;
	...
	public void run() {
		...
		data.add(new Data(new Distance(talon.getSelectedSensorPosition(PID_TYPE), Distance.Unit.MAGNETIC_ENCODER_TICK_CLIMBER),
	...
	public Distance getPosition(Time deltaTime) {
		...
		if (deltaTime.equals(Time.ZERO)) {
			return new Distance(talon.getSelectedSensorPosition(PID_TYPE), Distance.Unit.MAGNETIC_ENCODER_TICK_CLIMBER);
		}
		...
		return new Distance(interpolate(first.position.get(Distance.Unit.MAGNETIC_ENCODER_TICK_CLIMBER), second.position.get(Distance.Unit.MAGNETIC_ENCODER_TICK_CLIMBER), timestamp.div(second.timestamp.add(first.timestamp))), Distance.Unit.MAGNETIC_ENCODER_TICK_CLIMBER);

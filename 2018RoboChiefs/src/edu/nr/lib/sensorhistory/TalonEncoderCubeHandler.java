...
public class TalonEncoderCubeHandler extends TimerTask {
	...
	public TalonEncoderCubeHandler(TalonSRX talon) {
		this.talon = talon;
	...
	public void run() {
		...
		data.add(new Data(new Distance(talon.getSelectedSensorPosition(PID_TYPE), Distance.Unit.MAGNETIC_ENCODER_TICK_CUBE_HANDLER),
	...
	public Distance getPosition(Time deltaTime) {
		...
		if (deltaTime.equals(Time.ZERO)) {
			return new Distance(talon.getSelectedSensorPosition(PID_TYPE), Distance.Unit.MAGNETIC_ENCODER_TICK_CUBE_HANDLER);
		}
		...
		return new Distance(interpolate(first.position.get(Distance.Unit.MAGNETIC_ENCODER_TICK_CUBE_HANDLER), second.position.get(Distance.Unit.MAGNETIC_ENCODER_TICK_CUBE_HANDLER), timestamp.div(second.timestamp.add(first.timestamp))), Distance.Unit.MAGNETIC_ENCODER_TICK_CUBE_HANDLER);

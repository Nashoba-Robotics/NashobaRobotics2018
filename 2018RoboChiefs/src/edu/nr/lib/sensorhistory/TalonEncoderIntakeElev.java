...
public class TalonEncoderIntakeElev extends TimerTask{
	...
	public TalonEncoderIntakeElev(TalonSRX talon) {
		this.talon = talon;
	...
	public void run() {
		...
		data.add(new Data(new Distance(talon.getSelectedSensorPosition(PID_TYPE), Distance.Unit.MAGNETIC_ENCODER_TICK_INTAKE_ELEV),
	...
	public Distance getPosition(Time deltaTime) {
		...
		if (deltaTime.equals(Time.ZERO)) {
			return new Distance(talon.getSelectedSensorPosition(PID_TYPE), Distance.Unit.MAGNETIC_ENCODER_TICK_INTAKE_ELEV);
		}
		...
		return new Distance(interpolate(first.position.get(Distance.Unit.MAGNETIC_ENCODER_TICK_INTAKE_ELEV), second.position.get(Distance.Unit.MAGNETIC_ENCODER_TICK_INTAKE_ELEV), timestamp.div(second.timestamp.add(first.timestamp))), Distance.Unit.MAGNETIC_ENCODER_TICK_INTAKE_ELEV);

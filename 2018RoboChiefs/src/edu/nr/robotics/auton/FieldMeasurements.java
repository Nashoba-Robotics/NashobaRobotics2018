...
public class FieldMeasurements {
	...
	public static final Distance PLATFORM_ZONE_TO_SCALE_DIAGONAL = new Distance(54, Distance.Unit.INCH).sub(ROBOT_LENGTH.mul(0.5));
	
	public static final Distance FAR_START_POS_TO_FIELD_EDGE_Y = new Distance(29.69, Distance.Unit.INCH).add(ROBOT_WIDTH.mul(0.5));
	...
	public static final Distance CUBE_TO_PLATFORM_ZONE_X = new Distance(2, Distance.Unit.INCH);
	
	public static final Distance CUBE_TO_PLATFORM_ZONE_DIAGONAL = NRMath.hypot(
			FieldMeasurements.BASELINE_TO_PLATFORM_ZONE_X.sub(new Distance(196, Distance.Unit.INCH))
	...
	public static final Angle START_POS_MID_TO_SWITCH_ANGLE_LEFT = new Angle(Math.atan(
			(BASELINE_TO_SWITCH_X.sub(PUSH_OFF_WALL_X)).div(FIELD_WIDTH.mul(0.5).sub(FAR_START_POS_TO_FIELD_EDGE_Y)
					.add(ROBOT_WIDTH.mul(0.5).sub(new Distance(12, Distance.Unit.INCH))).add(new Distance(6, Distance.Unit.INCH)))),
			Angle.Unit.RADIAN);
	...
	public static final Angle PLATFORM_ZONE_TO_CUBE = new Angle(Math
			.atan((BASELINE_TO_PLATFORM_ZONE_X.sub(new Distance(196, Distance.Unit.INCH)).add(ROBOT_LENGTH.mul(0.5)).sub(BLOCK_WIDTH))

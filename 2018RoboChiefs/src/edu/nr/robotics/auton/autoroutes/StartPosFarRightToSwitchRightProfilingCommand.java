...
public class StartPosFarRightToSwitchRightProfilingCommand extends CommandGroup {
	...
	public StartPosFarRightToSwitchRightProfilingCommand() {
		...
		addSequential(new EnableMotionProfile(FieldMeasurements.BASELINE_TO_SWITCH_X, FieldMeasurements.BASELINE_TO_SWITCH_Y, 
				Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		
		addSequential(new TurnCommand(Drive.getInstance(), new Angle(-90, Angle.Unit.DEGREE), Drive.MAX_PROFILE_TURN_PERCENT, false));

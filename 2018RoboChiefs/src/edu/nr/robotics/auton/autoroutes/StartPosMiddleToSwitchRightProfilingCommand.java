...
addSequential(new EnableMotionProfile(FieldMeasurements.PUSH_OFF_WALL_X, Distance.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		...
		addSequential(new TurnPIDCommand(Drive.getInstance(), FieldMeasurements.START_POS_MID_TO_SWITCH_ANGLE_RIGHT, Drive.MAX_PROFILE_TURN_PERCENT, true));
		...
		addSequential(new TurnPIDCommand(Drive.getInstance(), (new Angle(90,Angle.Unit.DEGREE).add(FieldMeasurements.START_POS_MID_TO_SWITCH_ANGLE_RIGHT)).negate(), Drive.MAX_PROFILE_TURN_PERCENT, true));

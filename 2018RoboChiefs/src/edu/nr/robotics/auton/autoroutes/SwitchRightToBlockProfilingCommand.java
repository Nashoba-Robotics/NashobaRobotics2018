...
public class SwitchRightToBlockProfilingCommand extends CommandGroup {
	...
	//If strafing
		//addSequential(new EnableMotionProfile(FieldDistances.SWITCH_TO_PLATFORM_ZONE_Y, FieldDistances.SWITCH_TO_PLATFORM_ZONE_X, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));

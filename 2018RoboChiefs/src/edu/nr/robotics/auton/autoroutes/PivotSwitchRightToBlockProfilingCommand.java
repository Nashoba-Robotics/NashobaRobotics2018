...
public class PivotSwitchRightToBlockProfilingCommand extends CommandGroup {
	
	public PivotSwitchRightToBlockProfilingCommand() {
		...
		addSequential(new EnableMotionProfile(FieldMeasurements.SWITCH_TO_PIVOT_POINT_ZONE_X.negate(), Distance.ZERO, 
					Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		
		addSequential(new EnableLimelightCommand(true));
		
		addSequential(new TurnCommand(Drive.getInstance(), (new Angle(90, Angle.Unit.DEGREE).sub(FieldMeasurements.PIVOT_POINT_TO_CUBE_1)), 

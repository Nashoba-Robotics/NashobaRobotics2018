...
public class StartPosLeftToScaleLeftProfilingCommand extends CommandGroup {
	...
	public StartPosLeftToScaleLeftProfilingCommand() {
		...
		addSequential(new TurnPIDCommand(Drive.getInstance(), new Angle(90, Angle.Unit.DEGREE).sub(FieldMeasurements.PLATFORM_ZONE_TO_SCALE), Drive.MAX_PROFILE_TURN_PERCENT, true));
	}

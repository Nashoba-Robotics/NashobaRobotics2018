...
public class SwitchLeftToBlockProfilingCommand extends CommandGroup {
	...
	public SwitchLeftToBlockProfilingCommand() {
		...
		/*	
			addSequential(new EnableMotionProfile(FieldDistances.SWITCH_TO_PLATFORM_ZONE_Y, FieldDistances.SWITCH_TO_PLATFORM_ZONE_X.negate(), 
		...
		*/
		...
		//If not strafing
			...
			addSequential(new EnableMotionProfile(FieldDistances.SWITCH_TO_PLATFORM_ZONE_X, FieldDistances.SWITCH_TO_PLATFORM_ZONE_Y, 
					Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		...
		addSequential(new EnableMotionProfile(FieldDistances.FAR_START_POS_TO_OUTER_BLOCK_Y, Distance.ZERO, 
				Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		...
		addSequential(new EnableMotionProfile(FieldDistances.CUBE_TO_PLATFORM_ZONE_X.negate(), Distance.ZERO, 
				Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
	}

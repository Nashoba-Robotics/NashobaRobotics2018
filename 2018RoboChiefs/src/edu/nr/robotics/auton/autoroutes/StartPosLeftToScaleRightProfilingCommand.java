...
public class StartPosLeftToScaleRightProfilingCommand extends CommandGroup {
	...
	public StartPosLeftToScaleRightProfilingCommand() {
		...
		addSequential(new EnableMotionProfile(FieldDistances.BASELINE_TO_PLATFORM_ZONE_X, FieldDistances.BASELINE_TO_PLATFORM_ZONE_Y, 
		...
		addSequential(new EnableMotionProfile(FieldDistances.PLATFORM_ZONE_WIDTH, Distance.ZERO, 
				Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		
		/*
		//If Strafing
			addSequential(new EnableMotionProfile(FieldDistances.PLATFORM_ZONE_TO_SCALE_Y, FieldDistances.PLATFORM_ZONE_TO_SCALE_X.negate(),  
					Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));
		...
		*/
		...
		//If not strafing
			...
			addSequential(new EnableMotionProfile(FieldDistances.PLATFORM_ZONE_TO_SCALE_X, FieldDistances.PLATFORM_ZONE_TO_SCALE_Y,  
					Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));

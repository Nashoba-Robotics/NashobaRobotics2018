...
public class StartPosFarRightToScaleLeftProfilingCommand extends CommandGroup {
	...
	public StartPosFarRightToScaleLeftProfilingCommand() {
		...
		//If Strafing
		/*addSequential(new EnableMotionProfile(FieldDistances.PLATFORM_ZONE_TO_SCALE_Y, FieldDistances.PLATFORM_ZONE_TO_SCALE_X, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT));

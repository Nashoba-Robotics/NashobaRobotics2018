...
public class StartPosMiddleToSwitchLeftProfilingCommand extends CommandGroup {
	...
	public StartPosMiddleToSwitchLeftProfilingCommand() {
		...
		addSequential(new TurnPIDCommand(Drive.getInstance(), (new Angle(90, Angle.Unit.DEGREE).sub(FieldMeasurements.START_POS_MID_TO_SWITCH_ANGLE_LEFT)).negate(), 
		...
		addSequential(new TurnPIDCommand(Drive.getInstance(), new Angle(180, Angle.Unit.DEGREE).sub(FieldMeasurements.START_POS_MID_TO_SWITCH_ANGLE_LEFT), 
				Drive.MAX_PROFILE_TURN_PERCENT, true));

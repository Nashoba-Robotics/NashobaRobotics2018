...
public class StartPosFarRightToScaleRightProfilingCommand extends CommandGroup {
	...
	public StartPosFarRightToScaleRightProfilingCommand () {
		...
		addSequential(new TurnPIDCommand(Drive.getInstance(), (new Angle(90, Angle.Unit.DEGREE).sub(FieldMeasurements.PLATFORM_ZONE_TO_SCALE)).negate(), Drive.MAX_PROFILE_TURN_PERCENT, true));
	}

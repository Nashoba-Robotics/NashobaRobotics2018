...
public class BlockToScaleProfilingCommand extends CommandGroup {
	...
	public BlockToScaleProfilingCommand(int block) {
		...
		addSequential(new ConditionalCommand(new EnableMotionProfile(FieldMeasurements.PLATFORM_ZONE_WIDTH_BLOCK, Distance.ZERO, 
				Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT)) {
		...
		addSequential(new ConditionalCommand(new TurnCommand(Drive.getInstance(),
				(new Angle(180, Angle.Unit.DEGREE).sub(FieldMeasurements.PIVOT_POINT_TO_SCALE)).negate(),
				Drive.MAX_PROFILE_TURN_PERCENT, true)) {
		...
		addSequential(new ConditionalCommand(new TurnCommand(Drive.getInstance(),
				(new Angle(180, Angle.Unit.DEGREE).sub(FieldMeasurements.PIVOT_POINT_TO_SCALE)),
				Drive.MAX_PROFILE_TURN_PERCENT, true)) {

...
public class ElevatorProfileBasicTrajectorySmartDashboardCommand extends NRCommand {
	...
	public ElevatorProfileBasicTrajectorySmartDashboardCommand() {
		super(Elevator.getInstance());
		this.dist = Elevator.profileDeltaPos;

...
public class EnableMotionProfile extends NRCommand {
	...
	public EnableMotionProfile(Distance distX, Distance distY, double maxVelPercent, double maxAccelPercent) {
	...
	@Override
	public void onStart() {
		Drive.getInstance().enableMotionProfiler(distX, distY, maxVelPercent, maxAccelPercent);
